...
export class VitrineIncensoComponent {
  ...
  public lista: Produto[] = [
    {codigo:1, nome:"Incenso de camomila", descritivo:"Incenso de camomila para relaxamento e alivio do estresse",
      valor:9.99, quantidade:10, keywords:"ferramentas manuais",detalhe: "O incenso de alecrim ajuda a deixar os nervos mais calmos, proporcionando uma sensação plena de paz pouco tempo após o uso. Casos de ansiedade são reduzidos por meio do aroma, porque a fragrância age na mente como um tranquilizador natural, permitindo, assim, a dissipação dos pensamentos negativos e turbulentos."},
