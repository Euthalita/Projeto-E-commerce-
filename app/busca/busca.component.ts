...
export class BuscaComponent {
  ...
  public lista: Produto[] = [
    {codigo:1, nome:"Martelo", descritivo:"martelo cabo de borracha",
      valor:30.00, quantidade:10, keywords:"ferramentas manuais" , detalhe: "bla"},
    {codigo:2, nome:"Picareta", descritivo:"picareta cabo de borracha",
    valor:40.00, quantidade:10, keywords:"ferramentas manuais", detalhe: "bla"},
    {codigo:3, nome:"Pa", descritivo:"pa cabo de borracha",
    valor:50.00, quantidade:10, keywords:"ferramentas manuais", detalhe: "bla"},
    {codigo:4, nome:"Machado", descritivo:"machado cabo de borracha",
    valor:60.00, quantidade:0, keywords:"ferramentas manuais", detalhe: "bla"} 
  ];
